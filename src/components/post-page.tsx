    ...
    <main className="relative px-8 pb-24 lg:pb-32">
      ...
      <div className="relative z-10 mx-auto w-full max-w-[80ch] pt-16 text-white lg:pt-36 xl:-right-[calc(296px/2)] 2xl:right-auto">
        <div className="mb-8 flex items-center gap-2 sm:gap-4">
          {date && <div className="font-label text-[11px] text-gray-400">{date}</div>}
        </div>
        <h1 className="font-headline text-3xl leading-none text-pretty sm:text-6xl">
          {frontmatter.title}
        </h1>
        <h3 className="mt-2 text-lg leading-snug font-normal text-white/60 sm:mt-1 sm:text-xl sm:font-bold">
